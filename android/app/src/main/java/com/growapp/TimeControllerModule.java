...
public class TimeControllerModule extends ReactContextBaseJavaModule {
    ...
    public void startDailyService() {
        this.reactContext.startService(new Intent(this.reactContext, DailyTaskService.class));
    }
    
    @ReactMethod
    public void stopDailyService() {
        this.reactContext.stopService(new Intent(this.reactContext, DailyTaskService.class));
    }    
